...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2022/refs/heads/main/data/geojson.cumulative/enola-holmes-2-cumulative-aggregate.geojson.gz" data-map-title="Enola Holmes — enola-holmes-2" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Enola Holmes (enola-holmes-2) cumulative data map in new window" title="Opens interactive map for Enola Holmes (enola-holmes-2) data">Swarm Detail</a>
