...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2022/refs/heads/main/data/geojson.cumulative/raised-by-wolves-201-cumulative-aggregate.geojson.gz" data-map-title="Raised by Wolves — raised-by-wolves-201" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Raised by Wolves (raised-by-wolves-201) cumulative data map in new window" title="Opens interactive map for Raised by Wolves (raised-by-wolves-201) data">Swarm Detail</a>
