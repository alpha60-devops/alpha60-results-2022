...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2022/refs/heads/main/data/geojson.cumulative/kimi-cumulative-aggregate.geojson.gz" data-map-title="Kimi — kimi" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Kimi (kimi) cumulative data map in new window" title="Opens interactive map for Kimi (kimi) data">Swarm Detail</a>
