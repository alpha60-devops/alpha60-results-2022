...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2022/refs/heads/main/data/geojson.cumulative/atlanta-410-cumulative-aggregate.geojson.gz" data-map-title="Atlanta — atlanta-410" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Atlanta (atlanta-410) cumulative data map in new window" title="Opens interactive map for Atlanta (atlanta-410) data">Swarm Detail</a>
