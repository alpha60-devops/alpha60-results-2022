...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2022/refs/heads/main/data/geojson.cumulative/fistful-of-vengeance-cumulative-aggregate.geojson.gz" data-map-title="Fistful of Vengeance — fistful-of-vengeance" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Fistful of Vengeance (fistful-of-vengeance) cumulative data map in new window" title="Opens interactive map for Fistful of Vengeance (fistful-of-vengeance) data">Swarm Detail</a>
