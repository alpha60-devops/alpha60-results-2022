...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2022/refs/heads/main/data/geojson.cumulative/prey-cumulative-aggregate.geojson.gz" data-map-title="Prey — prey" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Prey (prey) cumulative data map in new window" title="Opens interactive map for Prey (prey) data">Swarm Detail</a>
