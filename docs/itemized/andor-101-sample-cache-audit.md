...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2022/refs/heads/main/data/geojson.cumulative/andor-101-cumulative-aggregate.geojson.gz" data-map-title="Andor — andor-101" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Andor (andor-101) cumulative data map in new window" title="Opens interactive map for Andor (andor-101) data">Swarm Detail</a>
