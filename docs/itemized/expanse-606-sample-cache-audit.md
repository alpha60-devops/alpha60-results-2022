...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2022/refs/heads/main/data/geojson.cumulative/expanse-606-cumulative-aggregate.geojson.gz" data-map-title="The Expanse — expanse-606" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open The Expanse (expanse-606) cumulative data map in new window" title="Opens interactive map for The Expanse (expanse-606) data">Swarm Detail</a>
