...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2022/refs/heads/main/data/geojson.cumulative/turning-red-cumulative-aggregate.geojson.gz" data-map-title="Turning Red — turning-red" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Turning Red (turning-red) cumulative data map in new window" title="Opens interactive map for Turning Red (turning-red) data">Swarm Detail</a>
