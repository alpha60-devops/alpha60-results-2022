...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2022/refs/heads/main/data/geojson.cumulative/sandman-01-cumulative-aggregate.geojson.gz" data-map-title="Sandman — sandman-01" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Sandman (sandman-01) cumulative data map in new window" title="Opens interactive map for Sandman (sandman-01) data">Swarm Detail</a>
