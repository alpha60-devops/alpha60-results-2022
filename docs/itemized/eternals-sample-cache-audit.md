...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2022/refs/heads/main/data/geojson.cumulative/eternals-cumulative-aggregate.geojson.gz" data-map-title="The Eternals — eternals" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open The Eternals (eternals) cumulative data map in new window" title="Opens interactive map for The Eternals (eternals) data">Swarm Detail</a>
