...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2022/refs/heads/main/data/geojson.cumulative/harley-quinn-301-cumulative-aggregate.geojson.gz" data-map-title="Harley Quinn — harley-quinn-301" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Harley Quinn (harley-quinn-301) cumulative data map in new window" title="Opens interactive map for Harley Quinn (harley-quinn-301) data">Swarm Detail</a>
